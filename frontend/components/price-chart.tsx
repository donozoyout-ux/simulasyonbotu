...
export function PriceChart({candles,levels,swings=[],entries=[],exits=[]}:{candles:Candle[];levels?:{support:number;resistance:number;supportLow?:number;supportHigh?:number;resistanceLow?:number;resistanceHigh?:number;entry?:number;stop?:number;target?:number};swings?:Array<{timestamp:string;price:number;type:string}>;entries?:TradeMarker[];exits?:TradeMarker[]}){
